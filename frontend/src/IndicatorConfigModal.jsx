          ...
          {loading ? (
            ...
            <>
              ...
              <div className="space-y-3">
                <h3 className="text-sm font-semibold text-white/80 uppercase tracking-wide">Data Configuration</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="text-sm text-white/70 mb-1.5 block">Symbol</label>
                    <input
                      type="text"
                      value={params.symbol || ''}
                  ...
                  <div>
                    <label className="text-sm text-white/70 mb-1.5 block">Interval</label>
                    <select
                  ...
                  <div>
                    <label className="text-sm text-white/70 mb-1.5 block">Provider</label>
                    <input
                      type="text"
