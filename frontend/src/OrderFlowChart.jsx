                ...
                <div className="px-4 py-2 bg-slate-800/30 border-b border-cyan-500/20">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <h3 className="text-sm font-semibold text-cyan-300">Footprint Chart</h3>
                            <div className="flex items-center gap-4 text-xs">
                                <div className="flex items-center gap-1">
                                    <div className="px-2 py-0.5 bg-green-500/70 text-white font-mono font-semibold rounded">More Buyers</div>
                                </div>
                                <div className="flex items-center gap-1">
                                    <div className="px-2 py-0.5 bg-red-500/70 text-white font-mono font-semibold rounded">More Sellers</div>
                                </div>
                                <div className="flex items-center gap-1">
